if (typeof (jQuery) != 'undefined') {
    ...
    pf_addons(document).ready(function($) {
        ...
        // copy zapier key from card

        $(document).on('click', '.copy-icon-zapier', function(event) {
            event.preventDefault();
            
            var apiKeyElement = $('.zapier-key');
            var apiKey = apiKeyElement.text();
            
            var tempInput = $('<input>');
            tempInput.val(apiKey);
