!function n(o, i, a) {
    ...
    14: [ function(e, t, r) {
        ...
        var p, y, d, m = function() {
            ...
            return e = o, r = [ {
                ...
                value: function() {
                    ...
                    e.append("nonce", pieforms_divi_builder.nonce), e.append("action", "pieforms_divi_preview"), 
                    e.append("form_id", this.props.form_id), e.append("show_title", this.props.show_title), 
                    e.append("show_desc", this.props.show_desc), fetch(pieforms_divi_builder.ajax_url, {
                        method: "POST",
                        cache: "no-cache",
                ...
                key: "render",
                value: function() {
                    var e = this.state, t = e.error, r = e.isLoaded, e = e.form, r = r ? "pieforms-divi-form-preview loading" : "pieforms-divi-form-preview";
                    return t || !e ? i.default.createElement("div", {
                        className: "pieforms-divi-form-placeholder"
                    }, i.default.createElement("img", {
                        src: pieforms_divi_builder.placeholder
                    }), i.default.createElement("h3", null, pieforms_divi_builder.placeholder_title)) : i.default.createElement("div", {
                        className: r
        ...
        d = "pieforms_selector", (y = "slug") in (p = m) ? Object.defineProperty(p, y, {
            value: d,
            enumerable: !0,
            configurable: !0,
            writable: !0
