...
$related_data = array(
    array(
        ...
        'name'          => esc_html__('Schedule Forms' , 'pie-forms'),
        ...
        'description'   => esc_html__( "Set up an opening and closing date on your forms for time-limited submissions" , 'pie-forms')

    ),
    array(
        'image'         => $images_url.esc_html('multipart-addon.png' , 'pie-forms'),              
        'name'          => esc_html__('Multipage Addon' , 'pie-forms'),
        ...
        'description'   => esc_html__( "Break your forms into small parts and multiple pages to provide a better user experience with the Multipage Forms Add-on" , 'pie-forms')         
    ),
    array(
        'image'         => $images_url.esc_html('drip-addon.png' , 'pie-forms'),              
        'name'          => esc_html__('Drip Addon' , 'pie-forms'),
        ...
        'description'   => esc_html__( "Design and schedule email campaigns to send automated response to your users with Pie Forms' Drip Add-on" , 'pie-forms')         
    ),     
    array(
        'image'         => $images_url.esc_html('file-upload.png' , 'pie-forms'),              
        'name'          => esc_html__('File Upload' , 'pie-forms'),
        ...
        'description'   => esc_html__( "The File Upload field in Pie Forms allows the user to upload documents, images, or videos on form submission" , 'pie-forms')          
    ),
    array(
        'image'         => $images_url.esc_html('limit-entries.png' , 'pie-forms'),              
        'name'          => esc_html__('Limit Entries' , 'pie-forms'),
        ...
        'description'   => esc_html__( "Pie Forms allows you to limit the number of form submissions for a particular form" , 'pie-forms')              
    ),
    array(
        'image'         => $images_url.esc_html('block-user.png' , 'pie-forms'),              
        'name'          => esc_html__('Block Users' , 'pie-forms'),
        ...
        'description'   => esc_html__( "Block unwanted users and bots by their Username, Email address, or IP address to keep your website spam-free" , 'pie-forms')
    )     
)
?>
