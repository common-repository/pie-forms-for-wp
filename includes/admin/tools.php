		...
		public static function environment() {
			...
			if(!empty($pie_form_ver)):
				...
				<div class="environment-info">
					<label class="info-label"><?php echo esc_html__("Pie Forms Version",'pie-forms') ?></label>
			...
			?>
			<div class="environment-info">
			<label class="info-label"><?php echo esc_html__("PHP Version",'pie-forms') ?></label>
			...
			<div class="environment-info">
			<label class="info-label"><?php echo esc_html__("MySQL Version",'pie-forms') ?></label>
			<?php
				global $wpdb;
			...
			<div class="environment-info">
            <label class="info-label"><?php echo esc_html__("Wordpress Version",'pie-forms') ?></label>
			...
			?>
 			...
 			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__("Curl",'pie-forms') ?></label>
				<?php
				if(function_exists('curl_version')):
				?>
					<span class="info-status"><?php echo esc_html__("Enable","pie-forms")?></span>
				<?php 
				else:
				?>
					<span class="info-status"><?php echo esc_html__("Disable","pie-forms")?></span>
				<?php endif; ?>
			</div>
			...
			?>
			 ...
			 <div class="environment-info">
				<label class="info-label"><?php echo esc_html__("File Get Contents",'pie-forms') ?></label>
				<?php 
			...
			?>
			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__("PHP Post Max Size",'pie-forms') ?></label>
				<span class="info-status"><?php echo esc_html(ini_get('post_max_size')) ?></span>
			</div>
			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__("PHP Time Limit",'pie-forms') ?></label>
			...
			?>
			<div class="environment-info">
                <label class="info-label"><?php echo esc_html__("WP Memory Limit",'pie-forms') ?></label>
			...
			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__("WP Debug Mode",'pie-forms') ?></label>
				<?php
				if ( defined('WP_DEBUG') && WP_DEBUG ):
				?>
					<span class="info-status"><?php echo esc_html__( 'Yes', 'pie-forms' ) ?></span> 
				<?php
					else:
				?>
				<span class="info-status">'<?php echo esc_html__( 'No', 'pie-forms' )?></span>
				<?php 
				endif;
				?>
			</div>
			...
			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__("WP Language",'pie-forms') ?></label>
			...
			<div class="environment-info">
				<label class="info-label"><?php echo esc_html__('WP Max Upload Size','pie-forms') ?></label>
