				...
				switch ( $value['type'] ) {
						...
						<tr valign="top">
							...
							<td class="forminp forminp-<?php echo esc_attr( $value['type'] ); ?>">
								...
								<input
									...
									<?php echo esc_attr(implode( ' ', $custom_attributes )); ?>
								>
								<button class="pform-btn-upload-grey pform-upld-header-img"><?php echo esc_html__( 'Upload Image', 'pie-forms' ); ?></button>
								<button class="pform-btn-upload-grey pform-rmv-header-img"><?php echo esc_html__( 'Remove Image', 'pie-forms' ); ?></button>
								<?php echo wp_kses_post($description);  ?>
							</td>
						</tr>
						<?php
					...
					case 'tinymce':
							...
							<?php
								...
								if (isset($genetech_products)){
									foreach ( $genetech_products as $plugin => $details ) :
										...
										if($plugin_data['details']->niche != 'automation'){
											continue;
										}?>
										<div class="sib-product-container">
											<div class="sib-product">
												<div class="sib-product-detail">
													...
													if( $plugin_data['details']->name == 'Zapier Integration' && Pie_Forms()->core()->pform_check_addon_exist('pie-forms-for-wp-zapier/pie-forms-for-wp-zapier.php')  ){
														if($is_activated == "Activated"){ ?>
														<div class="sib-product-detail-zapier">
															<p><?php echo wp_kses_post( $plugin_data['details']->desc )?></p>

														<h3><?php echo esc_html__( 'Your Pie Form API key:', 'pie-forms' )?></h3>
																<div class="sib-product-detail-zapier-apikey">
																	<code><div class="zapier-key"><?php echo PFORM_ZAPIER_Holder_Integration::get_apikey() ?></div><a class="copy-icon-zapier" href="#"><img src="<?php echo Pie_Forms::$url . 'assets/images/copy-icon.png' ?>" alt="Copy Icon"></a></code>
																</div>
															</div>
															<?php 
														}else{
															?>
															<p><?php echo wp_kses_post( $plugin_data['details']->desc )?></p>
															<p class="sib-product-detail-zapier-license"><?php echo esc_html__( 'Please activate License key to get Zapier API key', 'pie-forms' ) ?></p>
															<?php
														}
													}else{ ?>
														<p><?php echo wp_kses_post( $plugin_data['details']->desc )?></p>
												...
												<div class="sib-product-action">
													...
													if($plugin_data['status_class'] !== 'status-download'){
														?>
														<a class="automation-docs button" target="_blank" href="<?php echo esc_url( $plugin_data['details']->plugin_src ) ?>" data-type="plugin">
													...
													<?php
															...
															<div style="float: left; margin-right: 30px">
																<a class="get-addon button " target="_blank" href="<?php echo esc_url( $plugin_data['details']->buy_link ) ?>" data-type="plugin">
																	<?php esc_html_e( 'Get Addon', 'pie-forms' ); ?>
																</a>
															</div>
						...
						case 'payments_integration':
							...
							wp_enqueue_style( 'fontawesomev515', Pie_Forms::$url . 'assets/css/lib/fontawesome.min.css', array(), Pie_Forms::VERSION );
							wp_enqueue_script( 'fontawesome');
							Pie_Forms::template( '/addonPages/payments.php' );
						break;
