            ...
            Pie_Forms::template( 'recommended-docx.php' , array(
                'docx' => array(
                        array(
                            ...
                            'name'          => esc_html__('Make Your Forms Secure with Pie Forms' , 'pie-forms'),              
                            ...
                            'description'   => esc_html__( "Secure forms are crucial for your website. They do not only protect you from spam but also ensures security for your user’s data." , 'pie-forms')
    
                        ),
                        array(
                            'image'         => $images_url.esc_html('global-settings.png' , 'pie-forms'),              
                            'name'          => esc_html__('Global Settings' , 'pie-forms'),              
                            ...
                            'description'   => esc_html__( "Pie Forms Global settings can be configured from your Pie Forms Admin Dashboard." , 'pie-forms')
                        ),
                        array(
                            'image'         => $images_url.esc_html('email-settings.png' , 'pie-forms'),              
                            'name'          => esc_html__('Email Settings' , 'pie-forms'),              
                            ...
                            'description'   => esc_html__( "A confirmation email sent to your targeted audience to ascertain their online form submission is very essential." , 'pie-forms')     
                        ),
                        array(
                            'image'         => $images_url.esc_html('gdpr-appliance.png' , 'pie-forms'),              
                            'name'          => esc_html__('GDPR Compliance' , 'pie-forms'),              
                            ...
                            'description'   => esc_html__( "General Data Protection Regulation (GDPR) is a law by the European Union (EU) requiring explicit consent before collecting or storing user’s data." , 'pie-forms')     
                        )    
                    )
                )
            );
