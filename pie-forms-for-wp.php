        ...
        public static function instance()
        {
            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Pie_Forms ) ) {
                ...
                */
                ...
                if(!Pie_Forms()->core()->pform_check_addon_exist('pie-forms-for-wp-drip/pie-forms-for-wp-drip.php')){
                    self::$instance->menus[ 'dripCampaign' ]        = new PFORM_Admin_Menus_AddonPages_DripCampaign();
                }
                
                if(!Pie_Forms()->core()->pform_check_addon_exist('pie-forms-for-wp-broadcast/pie-forms-for-wp-broadcast.php')){
                    self::$instance->menus[ 'broadcastEmail' ]        = new PFORM_Admin_Menus_AddonPages_BroadcastEmail();
                }
                ...
                */
                ...
                $PFORM_Settings_Payments            = new PFORM_Settings_Payments();
