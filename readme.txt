...
Contributors: pieforms, genetechproducts
...
* **[Quiz/Survey Add-on](https://pieforms.com/addons/quiz-addon/)**
...
### 1.4.19
* Fixed: Escaping and sanitization issues for translations.
* Fixed: Removed deprecated Dynamic Properties issues.

### 1.4.18
* Fixed: Addressed Recaptcha V3 functionality.
* Fixed: Corrected behavior of the Single Payment Field in Email Templates.

### 1.4.17
* Fixed: Ajax Popup Message Issue.
* Fixed: Some UI Fixes.
